...
angular.element(document).ready(function () {
    ...
    angular.module("templates-desktop",
        ["views/modals/facebook.modal.html", "views/modals/message.modal.html", "views/modals/profile.photos.modal.html"]),
    angular.module("views/modals/facebook.modal.html", []).run(["$templateCache", function (a) {
